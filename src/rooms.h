...
#define ROOM_GRID_ART_CURSED    0x00200000  /* object is either k_idx or tval, but make it a cursed rand art */
...
#define ROOM_THEME_OBJECT      0x0040  /* Hack: All objects similar (e.g. Potions, Devices, ...) */
